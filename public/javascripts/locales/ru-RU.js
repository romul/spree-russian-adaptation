var I18n = {
  t: {
    "error_messages": {
        "unable_to_register_user":                  "Не удалось зарегистрировать пользователя.",
        "unable_to_register_due_server_error":      "Не удалось зарегистрироваться из-за ошибки на сервере.",
